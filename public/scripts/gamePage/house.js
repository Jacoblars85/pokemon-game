...
function openRewardDisplayPopUp(rewardId) {
  audio.openPc.play();
  document.getElementById("rewardDisplayOverlay").style.display = "flex";
...
function closeRewardDisplayPopUp() {
  document.getElementById("rewardDisplayOverlay").style.display = "none";
  audio.closeButton.play();
}
